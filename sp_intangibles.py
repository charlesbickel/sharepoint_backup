...
logger = logging.getLogger('sp.intangibles')

# Open and read IntangibleReports.xlsx. Read from 1st worksheet
workbook = xlrd.open_workbook("resources\\IntangibleReports.xlsx")
...
folder_location = r"\\NetworkFolderLocation\sp_archive" + "\\Intangibles\\"
...
def convert_url(xml):
    ...
    url = "http://sharepointwebsite.com/forms/Intangibles/" + ending
    return url
...
# Read 1st two columns of IntangibleReports.xlsx
def main():
